...
Defined in: [packages/oidc/src/get-vercel-oidc-token.ts:124](https://github.com/Android-studio61/vercel/blob/main/packages/oidc/src/get-vercel-oidc-token.ts#L124)
