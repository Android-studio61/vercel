...
Defined in: [packages/oidc/src/get-vercel-oidc-token.ts:64](https://github.com/Android-studio61/vercel/blob/main/packages/oidc/src/get-vercel-oidc-token.ts#L64)
