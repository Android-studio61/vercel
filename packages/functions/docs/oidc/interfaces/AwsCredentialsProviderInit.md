...
Defined in: [packages/functions/src/oidc/aws-credentials-provider.ts:20](https://github.com/Android-studio61/vercel/blob/main/packages/functions/src/oidc/aws-credentials-provider.ts#L20)
